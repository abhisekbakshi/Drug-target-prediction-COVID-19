...
from Drug_Autoencoder_train.Encoder_D_Net import AutoEncoder
...
f_name = input("Enter Drug Autoencoder trained model name : ")
...
save_load_model.save(model, f_name)
print(f_name," drug autoencoder model saved successfully")
